...
public class ListaEnlazada<T> implements Secuencia<T> {
    ...
    public void concatenar(ListaEnlazada<T> otra){
        this.ultimo.sig = otra.primero;
        otra.primero.prev = this.ultimo;
        this.ultimo = otra.ultimo;
        otra.primero = this.primero;
