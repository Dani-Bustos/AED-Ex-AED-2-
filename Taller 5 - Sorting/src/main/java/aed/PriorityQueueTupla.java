...
public class PriorityQueueTupla {
    ...
    private int tamaño;
    private Router[] representacion;

    // Complejidad : O(1)
    public PriorityQueueTupla(int buffer) {
        tamaño = 0;
        representacion = new Router[buffer];
    }

    // Complejidad : O(n), siendo n la longitud del arreglo.
    public PriorityQueueTupla(Router[] arreglo) {
        tamaño = arreglo.length;
        //In place
        representacion = arreglo;
